...
let showArrowController = true; // true or false
...
(function () {
	for (let i = 0; i < carouselItemSize; i++) {
		...
		carouselHyperLinkUrl && carouselHyperLink.setAttribute("href", `${carouselHyperLinkUrl}`);
		carouselHyperLinkUrl && carouselHyperLink.setAttribute("target", "_blank");
		...
		adLinkUrl && adHyperLink.setAttribute("href", `${adLinkUrl}`);
		adLinkUrl && adHyperLink.setAttribute("target", "_blank");
